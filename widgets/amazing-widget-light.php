...
/**
 * Elementor Amazing widget light widget.
 *
 * Elementor widget that displays an Amazing widget light icon, a headline and a text.
 *
 * @since 1.0.0
 */
...
class An_Amazing_Widget_light extends Widget_Base
{
    /**
     * Get widget name.
     *
     * Retrieve Amazing light widget name.
     *
    ...
    {
        return 'icon-box An_Amazing_Widget_light';
    }
    
    /**
     * Get widget title.
     *
     * Retrieve Amazing widget light title.
     *
    ...
    {
        return __( 'Amazing Neo light', 'amazing-neo-font-widget' );
    }
    
    /**
     * Get widget icon.
     *
     * Retrieve Amazing widget light icon.
     *
     ...
     *
     * Retrieve the list of categories the Amazing widget light belongs to.
     *
    ...
    protected function register_controls() {
        ...
        $this->add_control( 'icon', [
            ...
            'include' => [
                'anl an-abacus', 'anl an-ac', 'anl an-accessible-icon', 'anl an-accounts',
        ],
            'default' => 'an an-stethoscope',
        ] );
       ...
       $phone_description_text = [
        ...
        $this->add_control( 'amazing_widget_light_link', $amazing_light_link );
        $this->end_controls_section();
    ...
    {
        if ( empty($settings['amazing_widget_light_link']) ) {
            return '';
        }
        $value = '' . $settings['amazing_widget_light_link'];
        return $value;
    }
